const initApp=()=>{
    ...
    opButtons.forEach(button=>{
        button.addEventListener("click",(event)=>{
            ...
            if(itemArray.length){
                ...
                previousValueElm.textContent=`${newValue} ${newOperator}`
    ...
    const equalsBtton=document.querySelector(".equals");
    equalsBtton.addEventListener("click",()=>{
        const currentVal=currentValueElem.value;
        let equationObj;

        //pressing equals continuously
        ...
        previousValueElm.textContent=`${equationString} =`;
